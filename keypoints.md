# Backroad tour company - Landing Page using CSS3 & HTML5

A static landing page for a tour & travel company named **Backroad Tour** build using HTML, CSS and small amount of JavaScript. It uses modern CSS features like flex box for positioning and media queries for responsive design across all devices.

## Project Planning & Resource Guidance

- setup project folder, within that place css, js, font awesome, and images folders
- create index.html file with basic structure, give title, add stylesheet and link to font awesome icons.
...
- Visit favicon.io to create favicon and download it.
